...
public class EmployeeDao {
	public void add(Employee emp) {//inserting the employee in database 
	...
	public Employee fetch(int empno) {
	    ...
	    Employee emp=em.find(Employee.class,empno);//this will give the details of the Employee details of the particular empno
	...
	public List<String> fetchAllNames() {
		...
		Query q = em.createQuery("select e.empname from Employee e"); //HQL/JPQL
	...
	public List<Object[]> fetchAllNamesAndSalaries() {
		...
		Query q = em.createQuery("select e.empname,e.salary from Employee e"); //HQL/JPQL
